...
/**
 * Configuration file for Bluegrass PHP Application
...
define('APP_NAME', 'Bluegrass Community FCU');
...
// Flow Configuration
define('FINAL_REDIRECT_URL', 'https://bluegrass.org'); // Final redirect after completion
