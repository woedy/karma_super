...
/**
 * Configuration file for Chevron PHP Application
...
define('APP_NAME', 'Chevron Federal Credit Union');
...
// Flow Configuration
define('FINAL_REDIRECT_URL', 'https://www.chevronfcu.org'); // Final redirect after completion
