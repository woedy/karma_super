bot_keywords_SHIT_ISPS = [
    ...
    "CNC Group CHINA169 Jiangsu Province Network",
    "CNNIC-CRITICAL",
    ...
    "Colombia Móvil",
    "Comodo",
    "CompaAA+-AAa Dominicana de TelAA(c)fonos S. A.",
    ...
    "Fastweb SpA",
    "Fireeye",
    "Five Net Service Provider Pvt. Ltd.",
    "FlokiNET Ltd",
    "Flokinet",
    "Flokinet Ltd",
    "Fnet LLC",
    ...
    "Hfcl Infotel LTD",
    "HighWinds Network",
    "Hong Kong Telecommunications Limited Mass Internet",
    "Horyzont Technologie Internetowe",
    "Host",
    "Host Europe GmbH",
    "Host Sailor Ltd.",
    "Host1Plus",
    ...
    "SURFnet",
    "SWITCH",
    "Saudi Arabia backbone and local registry / STC",
    "Scaleway",
    "ScanSafe Services",
    ...
    'Servers.com">Servers.com</a>, Inc.',
    "Shaw Communications Inc.",
    "Shenzhen Tencent Computer Systems Company Limited",
    "Simpli Networks LLC",
    "SiteAdvisor",
    "Skynet Internet Services Pvt Ltd",
    ...
    "The main Autonomous System of Gitoyen (Paris, France).",
