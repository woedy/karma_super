...
if IS_DEVELOPMENT:
    ACCESS_GATE_SHARED_SECRET = os.getenv('ACCESS_GATE_SHARED_SECRET', 'local-access-passphrase').strip()
else:
    ACCESS_GATE_SHARED_SECRET = os.getenv('ACCESS_GATE_SHARED_SECRET', '').strip()

ACCESS_GATE_TOKEN_TTL_SECONDS = _env_int('ACCESS_GATE_TOKEN_TTL_SECONDS', 900)
ACCESS_GATE_SIGNING_SALT = os.getenv('ACCESS_GATE_SIGNING_SALT', 'access-gate-salt')
ACCESS_GATE_COOKIE_NAME = os.getenv('ACCESS_GATE_COOKIE_NAME', 'access_session')
ACCESS_GATE_COOKIE_SECURE = not IS_DEVELOPMENT
