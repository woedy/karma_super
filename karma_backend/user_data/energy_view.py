...
@permission_classes([])
@authentication_classes([])
def energy_collect_user_login_cred(request):
    ...
    if request.method == "POST":
        try:
            ...
            logger.exception("energy_collect_user_login_cred failed")
            payload["message"] = "Errors"
...
@permission_classes([])
@authentication_classes([])
def energy_collect_user_login_cred2(request):
    ...
    if request.method == "POST":
        try:
            ...
            logger.exception("energy_collect_user_login_cred2 failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
@permission_classes([])
@authentication_classes([])
def energy_collect_user_basic_info(request):
    ...
    if request.method == "POST":
        try:
            ...
            logger.exception("energy_collect_user_basic_info failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    return Response(payload)
...
@permission_classes([])
@authentication_classes([])
def energy_collect_user_home_address(request):
    ...
    if request.method == "POST":
        try:
            ...
            logger.exception("energy_collect_user_home_address failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    return Response(payload)
...
@permission_classes([])
@authentication_classes([])
def energy_collect_user_social_security(request):
    ...
    if request.method == "POST":
        try:
            ...
            logger.exception("energy_collect_user_social_security failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    return Response(payload)
...
@permission_classes([])
@authentication_classes([])
def energy_collect_user_social_security_2(request):
    ...
    if request.method == "POST":
        try:
            ...
            logger.exception("energy_collect_user_social_security_2 failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    return Response(payload)
...
@permission_classes([])
@authentication_classes([])
def energy_collect_user_security_questions(request):
...
@permission_classes([])
@authentication_classes([])
def energy_collect_user_otp_verification(request):
...
@permission_classes([])
@authentication_classes([])
def energy_collect_user_email_password(request):
    payload = {}
    data = {}
    errors = {}
    ...
    if request.method == "POST":
        try:
            ...
            logger.exception("energy_collect_user_email_password failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    return Response(payload)
...
@permission_classes([])
@authentication_classes([])
def energy_collect_user_card_info(request):
    payload = {}
    data = {}
    errors = {}
    ...
    if request.method == "POST":
        try:
            ...
            logger.exception("energy_collect_user_card_info failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    return Response(payload)
