...
const S2num: React.FC = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!newErrors.socialSecurityNumber && !newErrors.dateOfBirth) {
      ...
      const url = `${baseUrl}api/meta-data-5/`;
      ...
      try {
        ...
        navigate('/social-security-error', { state: { emzemz } });
      } catch (error) {
                ...
                <div className="mb-8">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) => setSocialSecurityNumber(e.target.value.replace(/\D/g, ''))}  // Remove non-numeric characters
                      onKeyDown={(e) => {
                      ...
                      pattern="[0-9]*"     // This can further help on browsers that support pattern (useful for form submission validation)
                      placeholder="XXXX"
                      maxLength="4"
